  ...
  return (
    <div className="docs">
      ...
      <p>
        ...
        https://clubview.netlify.app/, you are agreeing to be bound by these
      ...
      <p>
        ...
        on ClubView's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on ClubView's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let ClubView to terminate upon violations of any of these
      ...
      <p>
        All the materials on ClubView’s Website are provided "as is". ClubView
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, ClubView does not make any
      ...
      <p>
        ClubView or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        ClubView’s Website, even if ClubView or an authorize representative of
      ...
      <p>
        The materials appearing on ClubView’s Website may include technical,
        typographical, or photographic errors. ClubView will not promise that
        any of the materials in this Website are accurate, complete, or current.
        ClubView may change the materials contained on its Website at any time
        without notice. ClubView does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        ClubView has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by ClubView of the site. The use
      ...
      <p>
        ClubView may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to ClubView's Website shall be governed by the laws of
